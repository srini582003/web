    ...
    <div class="stu_box" >
        <div style="display:flex; align-items: start; justify-content: start; margin-left: 20px;">
            ...
            <div style="width: 200px;">
                ...
                <h3  class="trn_id"><?= $online['pay_id']; ?></h3>

                <h3  class="trn_date"><?= $online['pay_date']; ?></h3>
            </div>
            ...
            <button id="ConfirmBtn" value="<?= $online['reg_no']; ?>">Receive</button>
              ...
              <button id="DeleteBtn"  type="button" value="<?=$online['reg_no'];?>" class="bt">
     ...
     $(document).on('click', '#ConfirmBtn', function (e) {
                ...
                if(confirm(reg_no + ' Confirm Receive?'))
                {
                    ...
                    $.ajax({
                        ...
                        url: "code.srini",
                        data: {
                            'confirm_online_pay_verify': true,
                            'reg_no': reg_no
                        },
            ...
            $(document).on('click', '#DeleteBtn', function (e) {
                ...
                if(confirm('Are you sure you want to delete '+reg_no+' ?'))
                {

...
<div class="top w3-animate-top" >
    <img class="gcoe_logo" src="cl/gcoe_logo.png"/>
    <img class="grace_coe" src="cl/grace_coe.png" />
  </div>
  ...
  <center>
     ...
     <h1 class="dep_txt w3-animate-zoom">Department of ECE</h1>
     <h1 class="present">Proudly Presents</h1>
    <img class="logo" src="cl/logo.png" />
    <p class="sponser_txt w3-animate-zoom">SPONSORS</p>
    <div class="sponser w3-animate-zoom">
      <div class="sp_box">
      <img class="sp" src="sp/1.png" />
      </div>
      <div class="sp_box">
      <img class="sp" src="sp/2.png" />
      </div>
      <div class="sp_box">
      <img class="sp" src="sp/3.png" />
      </div>
    </div>
    <div class="sponser w3-animate-zoom">
      <div class="sp_box ">
      <img class="sp" src="sp/4.png" />
      </div>
      <div class="sp_box">
      <img class="sp" src="sp/5.png" />
      </div>
      <div class="sp_box">
      <img class="sp" src="sp/6.png" />
      </div>
    </div>
    <br>
    <div class="details w3-animate-opacity">
        <div onclick="eventDetail()" class="det_box">
          <h2 class="wood_txt"> Events Details</h2>
        </div>
        <div onclick="eventRule()" class="det_box">
          <h2 class="wood_txt"> Events Rules</h2>
        </div>
    </div>
<br>

<p style="color:green; font-size:12px;">*Terms and condition applied*</p>
<br>

    <div>
      <h6 style=" font-family:arial; font-weight:700">Contact Us</h6>
     <img onclick="instagram()" src="cl/insta_logo.png" width="50px">
    </div>

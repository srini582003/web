...
<div class="modal fade" id="stuAddModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <form id="addMassRegstudent" >
                ...
                <div class="mb-3">
                   <select placeholder="Register No" type="name" name="food" required class="fm-ip" >
                ...
                <div class="mb-3">
                   <select placeholder="Register No" type="name" name="pay_mode" required class="fm-ip" >
                ...
                <button id="add_next_logo" type="submit" style="margin-top:10px; width:120px; border:none; padding:6px; background-color:#3ea814;color:#fff; border-radius:20px; font-family: Arial; letter-spacing: 1px; font-weight: 600; font-size: 18px;">Register</button>
            </form>
            </center>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <center>
              ...
              <div class="container mt-4">
                    ...
                    <h3 style="margin-left:20px" >Registerd
...
<input id="nonveg_no" type="hidden" value="1"/>
    ...
    <div class="stu_box_nv" >
        <div style="display:flex; align-items: start; justify-content: start; margin-left: 20px;">
            ...
            <div style="width: 200px;">
                <h4 type="button"  class="stuname" ><?= $register['name']; ?></h4>
                <p class="regno"><?= $register['reg_no']; ?></p>
                <p class="sec"><?= $register['dep']; ?> ( <?= $register['year']; ?> Year )</p>
                <p class="mode">( Registerd <?= $register['pay_mode']; ?> Mode )</p>
                
            </div>

               <button type="button" value="<?=$register['reg_no'];?>" class="editstuBtn bt">
                <i style="color:green;" class="fa fa-pencil-square-o"  ></i>
              </button>
              <button style="margin-left:10px;" type="button" value="<?=$register['reg_no'];?>" class="deletestuBtn bt">
    ...
    <script>
        $(document).on('submit', '#addMassRegstudent', function (e) {
            e.preventDefault();
            ...
            formData.append("addMassRegstudent", true);
        ...
        $(document).on('click', '.editstuBtn', function () {
            ...
            $.ajax({
                type: "GET",
                url: "code.srini?Regreg_no=" + reg_no,
                success: function (response) {
        ...
        $(document).on('submit', '#uptMassRegstudent', function (e) {
            e.preventDefault();

            var formData = new FormData(this);
            formData.append("uptMassRegstudent", true);
